...
def uiExplorer(apkPath, saveDir, phoneDevice, tabletDevice):
    ...
    if clickBounds1 is None or len(clickBounds1) == 0:
        ...
        if not os.path.exists(subSaveDir):
            os.mkdir(subSaveDir)
        save_screen_data(subSaveDir, xml1, xml2, img1, img2, d1_activity, d2_activity)
    ...
    for i in clickBounds1:
        ...
        save_screen_data(subSaveDir, xml11, xml22, img11, img22, d1_activity, d2_activity)
    ...
    save_screen_data(subSaveDir, xmla, xmlb, imga, imgb, d1_activity, d2_activity)
